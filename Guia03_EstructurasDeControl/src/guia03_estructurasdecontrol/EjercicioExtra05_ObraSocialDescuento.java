...
public class EjercicioExtra05_ObraSocialDescuento {
    ...
    public static void main(String[] args) {
        ...
        switch (socio.toUpperCase()) {
            case "A":
                System.out.println("El costo del tratamiento para el socio A es: " + (costoTratamiento * 0.5));
                break;
            case "B":
                System.out.println("El costo del tratamiento para el socio B es: " + (costoTratamiento * 0.65));
                break;
            case "C":
                System.out.println("El costo del tratamiento para el socio C es: " + (costoTratamiento));
                break;
            default:
                System.out.println("Socio no válido");
        }
    }
}
